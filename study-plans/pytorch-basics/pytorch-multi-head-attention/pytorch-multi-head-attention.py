...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, Q, K, V):
        ...
        # Before: (B, S, d_model)
        # After reshape: (B, S, heads, head_dim)
        # Then transpose: (B, heads, S, head_dim)
        ...
        # Step 8 : Apply the final output projection.
        # Shape remains : (B, S, d_model)
